...
final class Version20200221125552 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP member, DROP skautis_user_id, DROP skautis_person_id, CHANGE password password VARCHAR(255) DEFAULT NULL COLLATE `utf8_bin`');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD member TINYINT(1) NOT NULL, ADD skautis_user_id INT DEFAULT NULL, ADD skautis_person_id INT DEFAULT NULL, CHANGE password password VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`');
